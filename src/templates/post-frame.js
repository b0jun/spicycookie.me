...
const Title = styled.h1`
  ...
  font-size: 2.2rem;
  font-weight: 900;
  color: ${props => props.theme.palette.postTitle};
...
const Header = styled.div`
  ...
  background: ${props => props.theme.palette.postTop};
  min-height: 200px;
  display: flex;
...
const StyledButton = styled(Button)`
  &:nth-child(1) {
    color: ${props => props.theme.palette.postTitle};
    border: 2px solid ${props => props.theme.palette.postTitle};
    &:hover {
      color: #eee;
      background: ${props => props.theme.palette.postTitle};
    }
  }
  &:nth-child(2) {
    color: ${props => props.theme.palette.postBtn};
    border: 2px solid ${props => props.theme.palette.postBtn};
    &:hover {
      color: #eee;
      background: ${props => props.theme.palette.postBtn};
    }
  }
`;
const Line = styled.div`
  ...
  background: linear-gradient(
    92deg,
    ${props => props.theme.palette.postLine1},
    ${props => props.theme.palette.postLine2},
    ${props => props.theme.palette.postBtn}
  );
  margin: 0 auto;
`;
